...
setup(
    ...
    description='Python Subkey Wrapper',  # Optional
    ...
    url='https://github.com/polkscan/py-subkey',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='Polkascan Foundation',  # Optional
    ...
    keywords='subkey polkascan substrate blockchain polkadot',  # Optional
    ...
    install_requires=['more-itertools', 'docker'],  # Optional
